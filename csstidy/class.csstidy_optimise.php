...
class csstidy_optimise
{
    ...
    function compress_important(&$string)
    {
        ...
        {
            $string = (new csstidy)->gvw_important($string) . '!important';
        }
        return $string;
    }
    ...
    function dissolve_4value_shorthands($property,$value)
    {
        ...
        if((new csstidy)->is_important($value))
        {
            $value = (new csstidy)->gvw_important($value);
            $important = '!important';
        }
    ...
    function merge_4value_shorthands($array)
    {
        ...
        foreach($shorthands as $key => $value)
        {
            ...
            && isset($array[$value[2]]) && isset($array[$value[3]]) && $value !== 0)
            {
                ...
                {
                    $val = $array[$value[$i]];
                    if((new csstidy)->is_important($val))
                    {
                        $important = '!important';
                        $return[$key] .= (new csstidy)->gvw_important($val).' ';
                    }
                    else
                    {
                        $return[$key] .= $val.' ';
    ...
    function dissolve_short_bg($str_value)
    {
        ...
        if((new csstidy)->is_important($str_value))
        {
            $important = ' !important';
            $str_value = (new csstidy)->gvw_important($str_value);
        }
    ...
    function merge_bg($input_css)
    {
        ...
        $bg_img_array = @csstidy_optimise::explode_ws(',', (new csstidy)->gvw_important($input_css['background-image']));
        $new_bg_value = '';
        $important = '';
        ...
        for($i = 0; $i < $number_of_values; $i++)
        {
            foreach($background_prop_default as $bg_property => $default_value)
            {
                ...
                // Remove !important
                if((new csstidy)->is_important($cur_value))
                {
                    $important = ' !important';
                    $cur_value = (new csstidy)->gvw_important($cur_value);
                }
